<template>
    <div class="bg-white overflow-hidden shadow-xl px-4 py-4 w-3/4   sm:rounded-lg">
        ...
        <div class="my-4">
            ...
            <div class=" ">
                <div v-if="categories" class="row">
                    <div class="col-md-6 mb-3">
                        <div class="p-3 border rounded-lg relative">
                            <h2 class="text-2xl text-gray-800 mb-2">{{ categories.name }}</h2>

                            <div class="absolute top-2 right-2 text-gray-400 cursor-pointer"
                                 @click="clickTool(categories.id)">
                                ...
                                <div class="w-40 p-3 absolute  right-0 rounded-md bg-white text-gray-700 "
                                     v-if="isOpenTool === categories.id">
                                    <button class="cursor-pointer hover:text-red-700" @click="updateBio(categories)">
                                        Update categories
                                    </button>
                                </div>
                            </div>
